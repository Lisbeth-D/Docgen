                    ...
                    <div class="conv-grid">
                        ...
                        <div class="conv-group">
                            ...
                            <input
                                ...
                                value="{{ old('tipo_procedimiento') }}"
                                class="@error('tipo_procedimiento') input-error @enderror"
                            >
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const inputTipoProcedimiento =
        document.getElementById('tipo_procedimiento');
    ...
    function buscarProcedimiento(valor) {
        ...
        fetch(
            `/buscar-procedimiento/${encodeURIComponent(valor)}`,
            {
                headers: {
