...
<div class="admin-layout">
    ...
    <div class="admin-content">
        ...
        <div class="conv-wrapper">
            ...
            <form
                id="form-acta-fallo"
                action="{{ route('fallo.acta.generar') }}"
                method="POST"
                    ...
                    <div class="conv-grid">
                        ...
                        <div class="conv-group">
                            ...
                            >
                                ...
                                @empty
                                    <option value="" disabled>
                                        No hay personas registradas en Subgerencia de Operaciones
                                    </option>
                                @endforelse
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const buscarProcedimientoBaseUrl =
        @json(url('/fallo/buscar'));

    const formulario =
        document.getElementById('form-acta-fallo');
